...
export const DEFAULT_ASSETS: Record<string, AirasAsset> = {
  ...
  retro_bench: {
    ...
    category: 'furniture',
    sprite: {
      url: '/assets/objects/bench_down.png',
      width: 48,
      height: 36,
      pixelArt: true,
      directionalUrls: {
        down: '/assets/objects/bench_down.png',
        'down-left': '/assets/objects/bench_down-left.png',
        left: '/assets/objects/bench_left.png',
        'up-left': '/assets/objects/bench_up-left.png',
        up: '/assets/objects/bench_up.png',
        'up-right': '/assets/objects/bench_up-right.png',
        right: '/assets/objects/bench_right.png',
        'down-right': '/assets/objects/bench_down-right.png',
      },
    },
    anchor: { x: 24, y: 34 },
